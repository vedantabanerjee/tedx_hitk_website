    ...
    <div className="flex flex-col items-center">
      <div className="grid grid-cols-4 gap-4 text-center">
        {["days", "hours", "minutes", "seconds"].map((interval) => (
          <div
            key={interval}
            className="flex flex-col items-center justify-center rounded-lg bg-gray-800 p-4 shadow-md"
          >
            <div className="relative overflow-hidden rounded bg-gray-900 px-4 py-6 shadow-inner">
