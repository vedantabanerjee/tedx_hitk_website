...
export default function SpeakerCard({
  ...
  return (
    ...
    >
      ...
      >
        {/* Front of card */}
        <div className="absolute inset-0 backface-hidden rounded-lg bg-gray-900 shadow-lg">
        ...
        {/* Back of card */}
        <div className="absolute inset-0 backface-hidden rounded-lg bg-gray-900 p-6 shadow-lg rotate-y-180">
          <div className="flex h-full flex-col justify-between">
            <div>
              <h3 className="text-xl font-bold text-white">{name}</h3>
              <p className="mb-2 text-sm text-[#E62B1E]">{role}</p>
              <h4 className="mb-2 font-medium text-white">"{talkTitle}"</h4>
